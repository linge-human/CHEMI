...
function loadQuestionInputs(calcId, questionIndex) {
    ...
    // Store the expected question data for later comparison (don't auto-fill!)
    log('Question data available for checking:', question.inputs);
    ...
    try {
        ...
        if (result && result.value !== null && result.value !== undefined) {
            ...
            if (calcCard && calcCard.classList.contains('practice-active') && calcCard.dataset.expectedResult) {
                checkPracticeAnswer(calcInstanceId, result.value);
            }
        } else {
